#' Getting Outbreak Investigation Numbers
#'
...
#'
#' @examples
#' getting_outbreak_investigation_numbers(clean_ccm_investigations_data, clean_ccm_outbreaks_dat)
getting_outbreak_investigation_numbers <- function(clean_ccm_investigations_data, clean_ccm_outbreaks_data) {
  ...
  get_outbreak_investigation_numbers <- clean_ccm_investigations_data %>%
  ...
  assert_investigation_numbers(investigation_numbers, get_outbreak_investigation_numbers)

  return(get_outbreak_investigation_numbers)
}
