#' Getting Ever Ventilated Investigation Numbers
#'
#' This function takes the CCM risk factors data and generates a vector of investigation numbers corresponding
#' to those records where the cases had an intervention of intubated with invasive ventilation at any time.
#'
...
#'
#' @examples
#' getting_ever_ventilated_investigation_numbers(clean_ccm_investigations_data, clean_ccm_interventions_data)
getting_ever_ventilated_investigation_numbers <-
  function(clean_ccm_investigations_data,
    ...
    get_ever_ventilated_investigation_numbers <- clean_ccm_interventions_data %>%
      filter(
    ...
    assert_investigation_numbers(investigation_numbers, get_ever_ventilated_investigation_numbers)

    return(get_ever_ventilated_investigation_numbers)
  }
