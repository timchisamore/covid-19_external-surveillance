plan <- drake_plan(
  ...
  get_tableau_linelist = getting_tableau_linelist(clean_ccm_investigations_data, clean_ccm_outcomes_data, clean_ccm_interventions_data, clean_ccm_risk_factors_data, clean_ccm_outbreaks_data),
  tableau_linelist = openxlsx::write.xlsx(get_tableau_linelist, file_out(!!here::here("data", "clean", "tableau_linelist.xlsx"))),
