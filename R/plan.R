plan <- drake_plan(
  ...
  get_tableau_linelist = getting_tableau_linelist(clean_ccm_investigations_data, clean_ccm_outcomes_data, clean_ccm_interventions_data, clean_ccm_risk_factors_data, clean_ccm_outbreaks_data, clean_municipal_conversion_data),
  tableau_linelist = openxlsx::write.xlsx(get_tableau_linelist, file_out(!!here("data", "clean", "tableau_linelist.xlsx"))),
  ...
  get_cases_by_reported_date_and_case_type_plot = getting_cases_by_reported_date_and_case_type_plot(get_tableau_linelist),
  get_case_outcomes_table = getting_case_outcomes_table(get_tableau_linelist),
  get_case_type_by_outcome_table = getting_case_type_by_outcome_table(get_tableau_linelist),
  get_case_interventions_table = getting_case_interventions_table(get_tableau_linelist),
  get_case_demographics_table = getting_case_demographics_table(get_tableau_linelist),
